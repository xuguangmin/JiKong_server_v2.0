...
{
#if 0
	static __sighandler_t previous_SIGWINCH_handler;  /* for reset  sighandler_t*/
...
prepare_to_die:
				...
				printf("cmdedit_read_input exit");
				goto_new_line();
...
#if MAX_HISTORY >= 100  /*1 jiayangang*/
